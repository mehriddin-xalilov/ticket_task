...
class HTML
{
	...
	private static function _watermark($m)
	{
        ...
        return '<noindex><span class="fake invisible" style="position:absolute;display:block;width:0;height:0;text-indent:-2989px;font-size:0;opacity:0.01;pointer-events:none;">&nbsp;&copy;&nbsp;' . htmlspecialchars($url, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') . '</span></noindex>' . $m[0];
